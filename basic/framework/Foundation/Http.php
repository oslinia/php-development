...
class Http extends Routing\Mapper
{
    ...
    public function __construct(string $routing, string $src)
    {
        parent::init($routing, $src);
    ...
    public static function request(string $dirname): void
    {
        ...
        new static($resource . 'routing', $src);
    }
    ...
    public static function collect(array $args): null|string
    {
        ...
        if (isset(parent::$map->urls[$name])) {
            $link = parent::$map->urls[$name];
